...
// No 'positive' key exists in S2's `color` (text) scale — only backgroundColor/fill
// have it. Green is applied via CSS (.es-gate-registration__step-label), same as
// the existing "Generated by …" note.
export const positiveStatus = style({ font: 'body-xs', fontWeight: 'bold' });
...
export const generatedNote = style({ font: 'body-xs' }); // "Registered for …" footnote (green via CSS: .es-gate-registration__registered)

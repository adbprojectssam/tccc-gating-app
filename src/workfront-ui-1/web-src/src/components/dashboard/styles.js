...
export const dropzoneTitle = style({ fontSize: 'ui-lg', fontWeight: 'bold', color: 'heading' }); // "Drag and drop your file" 16px bold
export const generatingLabel = style({ fontSize: 'ui', fontWeight: 'bold', color: 'heading' }); // "Generating from saved artifact:" 14px bold
export const generatedNote = style({ font: 'body-xs' }); // "Generated by …" footnote (green via CSS: .es-preread__generated)

...
/* Configure Approvers row fields (Picker/SearchField) — 178px (Figma's 192px
   minus room for the rows list's reserved scrollbar gutter, see
   .es-approver-dialog__rows in dashboard.css). */
export const approverFieldWidth = style({ width: 178 });

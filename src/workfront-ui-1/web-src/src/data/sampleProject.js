  ...
  tabs: [
    ...
    },
    {
      ...
      panel: {
        ...
        risks: [
          { id: 'margin', title: 'Margin analysis overdue since June 12 - blocking FIN sign-off', severity: { label: 'High', tone: 'high' } },
          { id: 'formula', title: 'Formula stability at shelf temperature - mitigation in progress', severity: { label: 'Medium', tone: 'medium' } },
          { id: 'senasica', title: 'SENASICA regulatory label review pending', severity: { label: 'Medium', tone: 'medium' } },
          { id: 'tech', title: 'TECH feasibility still in review', severity: { label: 'Medium', tone: 'medium' } },
        ],
      },
    },
  ],

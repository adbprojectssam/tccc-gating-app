...
export const LABELS = {
  ...
  fieldReview: {
    ...
    conflictWorkfrontLabel: 'From Workfront (Existing Value)',
    conflictDocLabel: 'High Confidence',
    conflictWorkfrontCaption: 'Current project value',
    conflictDocCaption: 'Uploaded document value',
    conflictOptionWorkfront: '{value} (Workfront)',
    conflictOptionDoc: '{value} (Document)',
    foundIn: 'Found in {doc}',
    confidenceCaption: 'Extracted at {percent}% confidence',
    save: 'Save',
  ...
  gateRegistration: {
    complete: 'Pre-read generated',
    heading: 'Pre-read generated for Gate {number}',
    body: 'The pre-read has been successfully created. Use View Pre-read to review and validate the extracted information.',
    ...
    registeredSharedBadge: 'Registered - Pre-read shared',
    ...
    upcomingTitle: 'Upcoming Gate Meetings',
    upcomingSubtitle: 'Showing meetings across all projects',
    calendarHint: 'Dates with an event are marked below - select one from the calendar or the list.',
    pagination: 'Meeting pages',
    ...
    gateFilter: 'All Levels',
    allEvents: 'All Events',
    allGates: 'All Levels',
    clearFilters: 'Clear All',
    meetingColumn: 'Meeting/Gate',
    projectColumn: 'Project',
    dateColumn: 'Date & Time',
    facilitatorColumn: 'Facilitator',
    eligibilityColumn: 'Eligibility',
    gateLabel: 'Gate 1',
    projectLabel: 'Gate project',
    facilitatorUnknown: 'Unassigned',
